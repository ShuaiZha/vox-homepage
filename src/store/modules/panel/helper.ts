...
const defaultFooterHtml = '<div class="flex justify-center text-slate-300" style="margin-top:100px">Powered By <a href="https://github.com/ShuaiZha/vox-homepage" target="_blank" class="ml-[5px]">homepage</a></div>'
