...
import (
	...
	"os"
	"vox-homepage/global"
	"vox-homepage/initialize/cUserToken"
	"vox-homepage/initialize/config"
	"vox-homepage/initialize/database"
	"vox-homepage/initialize/lang"
	"vox-homepage/initialize/other"
	"vox-homepage/initialize/redis"
	"vox-homepage/initialize/runlog"
	"vox-homepage/initialize/systemSettingCache"
	"vox-homepage/initialize/userToken"
	"vox-homepage/lib/cmn"
	"vox-homepage/models"
	"vox-homepage/structs"
	"time"
