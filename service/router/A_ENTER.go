...
import (
	"vox-homepage/global"
	// "vox-homepage/router/admin"
	"vox-homepage/router/openness"
	"vox-homepage/router/panel"
	"vox-homepage/router/system"
...
func InitRouters(addr string) error {
	...
	global.Logger.Info("homepage is Started.  Listening and serving HTTP on ", addr)
